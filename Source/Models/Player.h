...
// flag indicating if this player initiated the session
@property (readwrite) BOOL isSessionCreator;

// ID generated by MongoDB
// this is set if/when a player is posted
// to the REST API
@property (readwrite) NSString* mongoID;
